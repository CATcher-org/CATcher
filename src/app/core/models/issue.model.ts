...
export class Issue {
  ...
  public static createPhaseTeamResponseIssue(githubIssue: GithubIssue, teamData: Team): Issue {
    ...
    issue.teamResponse = template.teamResponse === undefined ? undefined : Issue.updateTeamResponse(template.teamResponse);
  ...
  public static createPhaseTesterResponseIssue(githubIssue: GithubIssue): Issue {
    ...
    issue.teamResponse =
      testerResponseTemplate.teamResponse === undefined ? undefined : Issue.updateTeamResponse(testerResponseTemplate.teamResponse);
