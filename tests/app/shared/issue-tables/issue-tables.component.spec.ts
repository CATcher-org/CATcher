...
describe('IssueTablesComponent', () => {
    ...
    describe('fitTitleText()', () => {
        beforeEach(() => {
        issueTablesComponent = new IssueTablesComponent(null, null, null, null, null, null, null);
        });
        ...
        it('should format the title text to account for words longer than max word length', () => {
            ...
            const LONG_TITLE = '01234567890123456789012345678901234567890123456789 01234567890123456789012345678901234567890123456789';
            const FORMATTED_TITLE = '01234567890123456789012345678901234567... 01234567890123456789012345678901234567...';
            expect(issueTablesComponent.fitTitleText(LONG_TITLE)).toEqual(FORMATTED_TITLE);
        });

        it('should retain original title if words are not longer than max word length', () => {
            // title consisting of 2 words of 30 characters
            const SHORT_TITLE = '012345678901234567890123456789 012345678901234567890123456789';
