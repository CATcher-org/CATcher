...
export const TYPE_DOCUMENTATION_BUG_LABEL = new Label(TYPE, TYPE_DOCUMENTATION_BUG, COLOR_TYPE_DOCUMENTATION_BUG, DEFINITION_DOCUMENTATION_BUG);
export const TYPE_FUNCTIONALITY_BUG_LABEL = new Label(TYPE, TYPE_FUNCTIONALITY_BUG, COLOR_TYPE_FUNCTIONALITY_BUG, DEFINITION_FUNCTIONALITY_BUG);
